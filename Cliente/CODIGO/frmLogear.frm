...
Private Sub cmdCuenta_Click()
    ...
    Call TextoAlAsistente("Buena suerte en tu nueva aventura!")
    
    Call GuardarServidor
...
Private Sub cmdIngresar_Click()
    ...
    If IntervaloPermiteConectar Then
        Call TextoAlAsistente("Conectando...")
...
Private Sub lstServidores_Click()
    If UBound(Servidores) > lstServidores.ListIndex Then
        txtIp.Text = Servidores(lstServidores.ListIndex + 1).Host
        txtPort.Text = Servidores(lstServidores.ListIndex + 1).Puerto
    End If
End Sub
