...
Public Sub LoadImpAoInit()
    ...
    file = RESOURCES_PATH & "/OUTPUT/" & "Teclas.ini"
...
Public Sub SaveRAOInit()
    ...
    Arch = RESOURCES_PATH & "/OUTPUT/" & "Teclas.ini"
    ...
    Select Case KeyCode
        ...
        Case BindKeys(2).KeyCode
            ...
            If Not Comerciando Then
                Call AgarrarItem
            Else
                Call AddToConsole("No podes agarrar objetos mientras comercias", 255, 0, 32, False, False, False)
        ...
        Case BindKeys(3).KeyCode
            ...
            If Not Comerciando Then
                Call TirarItem
            Else
                Call AddToConsole("No podes tirar objetos mientras comercias", 255, 0, 32, False, False, False)
    
            End If
    
        Case BindKeys(6).KeyCode
            If SeguroGame Then
                Call AddToConsole("Para desactivar el seguro escribe /SEG o usa el botón en la pestaña MENU en la esquina inferior derecha.", 255, 0, 0, True, False, False)
            Else
        ...
        Case BindKeys(10).KeyCode
            ...
            If UserMoving Then Exit Function
        ...
        Case BindKeys(19).KeyCode
            ...
            Arch = RESOURCES_PATH & "/OUTPUT/" & "Configuracion.ini"
        ...
        Case BindKeys(23).KeyCode
            ...
            End If
        Case BindKeys(25).KeyCode
            If UserCharIndex > 0 Then
                ConsoleDialog.consola_transparente = Not ConsoleDialog.consola_transparente
                If ConsoleDialog.consola_transparente Then
                    ConsoleDialog.Alpha = 60
                Else
                    ConsoleDialog.Alpha = 255
                End If
            End If
