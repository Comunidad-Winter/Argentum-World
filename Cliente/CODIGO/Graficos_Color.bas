...
Function RGBA_2_D3DCOLORVALUE(Color As RGBA) As D3DCOLORVALUE
    '***************************************************
    'Author: Alexis Caraballo (WyroX)
    '***************************************************
    
    On Error GoTo RGBA_2_D3DCOLORVALUE_Err
    
    RGBA_2_D3DCOLORVALUE.r = Color.r / 255
    RGBA_2_D3DCOLORVALUE.G = Color.G / 255
    RGBA_2_D3DCOLORVALUE.B = Color.B / 255
    RGBA_2_D3DCOLORVALUE.A = Color.A / 255
    
    Exit Function

RGBA_2_D3DCOLORVALUE_Err:
    Call RegistrarError(err.Number, err.Description, "Graficos_Color.RGBA_2_D3DCOLORVALUE", Erl)
    Resume Next
