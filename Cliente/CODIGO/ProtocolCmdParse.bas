        ...
        Select Case Comando
            ...
            Case "/GO"
                If EsGM Then
                    ...
                    Else
                        Select Case UCase$(ArgumentosRaw)
                            Case "ULLA", "ULLATHORPE"
                                Call WriteWarpChar("YO", 1, 426, 1084)
                            Case "NIX"
                                Call WriteWarpChar("YO", 1, 335, 1424)
                            Case "BANDER", "BANDERBILL"
                                Call WriteWarpChar("YO", 1, 438, 283)
                            Case "ARGHAL", "ARG"
                                Call WriteWarpChar("YO", 1, 718, 357)
                            Case "ARKHEIN", "ARK"
                                Call WriteWarpChar("YO", 1, 610, 1600)
                            Case "LINDOS"
                                Call WriteWarpChar("YO", 1, 1164, 1087)
                            Case "ESPE", "ESPERANZA"
                                Call WriteWarpChar("YO", 1, 1125, 1660)
                            Case "POLO"
                                Call WriteWarpChar("YO", 1, 1010, 210)
                            Case Else
                                Call WriteGoToChar(ArgumentosRaw)
                        End Select
            ...
            Case "/LIMPIARCONSOLA", "/CLEAR"
                Call ConsoleDialog.Clear
...
Public Sub ShowConsoleMsg(ByVal message As String, Optional ByVal red As Integer = 255, Optional ByVal green As Integer = 255, Optional ByVal blue As Integer = 255, Optional ByVal bold As Boolean = False, Optional ByVal italic As Boolean = False)
    ...
    Call AddToConsole(message, red, green, blue, bold, italic)
