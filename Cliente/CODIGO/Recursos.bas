...
Sub CargarDatosMapa(ByVal map As Integer)
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Maps, RESOURCES_PATH & "/OUTPUT/", "mapa" & map & ".csm", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        MapRoute = RESOURCES_PATH & "/MAPAS/mapa" & map & ".csm"
    #End If
        ...
        With MH
            ...
            If .NumeroBloqueados > 0 Then
                ...
                For i = 1 To .NumeroBloqueados
                    ...
                    'MapData(rrX(Blqs(i).X), rrY(Blqs(i).Y)).Blocked = 1
                Next i
            ...
            If .NumeroLayers(1) > 0 Then
                ...
                For i = 1 To .NumeroLayers(1)
                    ...
                    ' MapData(rrX(L1(i).X), rrY(L1(i).Y)).Graphic(1).grhindex = L1(i).grhindex
            
                    '  InitGrh MapData(rrX(L1(i).X), rrY(L1(i).Y)).Graphic(1), MapData(rrX(L1(i).X), rrY(L1(i).Y)).Graphic(1).grhindex
            ...
            If .NumeroLayers(2) > 0 Then
                ...
                For i = 1 To .NumeroLayers(2)
                    ...
                    '   MapData(rrX(L2(i).X), rrY(L2(i).Y)).Graphic(2).grhindex = L2(i).grhindex
            
                    '  InitGrh MapData(rrX(L2(i).X), rrY(L2(i).Y)).Graphic(2), MapData(rrX(L2(i).X), rrY(L2(i).Y)).Graphic(2).grhindex
                Next i
            ...
            If .NumeroLayers(3) > 0 Then
                ...
                For i = 1 To .NumeroLayers(3)
                    ...
                    '  MapData(rrX(L3(i).X), rrY(L3(i).Y)).Graphic(3).grhindex = L3(i).grhindex
            
                    ' InitGrh MapData(rrX(L3(i).X), rrY(L3(i).Y)).Graphic(3), MapData(rrX(L3(i).X), rrY(L3(i).Y)).Graphic(3).grhindex
                Next i
            ...
            If .NumeroLayers(4) > 0 Then
                ...
                For i = 1 To .NumeroLayers(4)
                    ...
                    '   MapData(rrX(L4(i).X), rrY(L4(i).Y)).Graphic(4).grhindex = L4(i).grhindex
                    '   MapData(rrX(L4(i).X), rrY(L4(i).Y)).GrhBlend = 255
                    '   InitGrh MapData(rrX(L4(i).X), rrY(L4(i).Y)).Graphic(4), MapData(rrX(L4(i).X), rrY(L4(i).Y)).Graphic(4).grhindex
                Next i
            ...
            If .NumeroTriggers > 0 Then
                ...
                For i = 1 To .NumeroTriggers
                    ...
                    '      MapData(rrX(Triggers(i).X), rrY(Triggers(i).Y)).Trigger = Triggers(i).Trigger
                Next i
            ...
            If .NumeroLuces > 0 Then
                ...
                For i = 1 To .NumeroLuces
                    ...
                    '  LightRound.Create_Light_To_Map Luces(I).x, Luces(I).y, CByte(MapData(rrX(Luces(I).x), rrY(Luces(I).y)).luz.Rango), MapData(rrX(Luces(I).x), rrY(Luces(I).y)).luz.color
                    'LucesCuadradas.Light_Create Luces(i).X, Luces(i).Y, MapData(rrX(Luces(i).X), rrY(Luces(i).Y)).luz.color, MapData(rrX(Luces(i).X), rrY(Luces(i).Y)).luz.Rango, Luces(i).X & Luces(i).Y
                    'LightRound.Render_All_Light
                    'LucesRedondas.Create_Light_To_Map Luces(i).X, Luces(i).Y, CByte(MapData(rrX(Luces(i).X), rrY(Luces(i).Y)).luz.Rango), 255, 255, 255
                    '   LucesCuadradas.Light_Create Luces(i).X, Luces(i).Y, MapData(rrX(Luces(i).X), rrY(Luces(i).Y)).luz.color, MapData(rrX(Luces(i).X), rrY(Luces(i).Y)).luz.Rango, Luces(i).X & Luces(i).Y
            ...
            If .NumeroOBJs > 0 Then
                ...
                For i = 1 To .NumeroOBJs
                    '                 MapData(rrX(Objetos(i).X), rrY(Objetos(i).Y)).OBJInfo.OBJIndex = Objetos(i).OBJIndex
                    '   MapData(rrX(Objetos(i).X), rrY(Objetos(i).Y)).OBJInfo.Amount = Objetos(i).ObjAmmount
                    '    MapData(rrX(Objetos(i).X), rrY(Objetos(i).Y)).ObjGrh.grhindex = ObjData(Objetos(i).OBJIndex).grhindex
       
                    '    Call InitGrh(MapData(rrX(Objetos(i).X), rrY(Objetos(i).Y)).ObjGrh, MapData(rrX(Objetos(i).X), rrY(Objetos(i).Y)).ObjGrh.grhindex)
...
Public Sub CargarMapa(ByVal map As Integer)
    ...
    If MapSize.Width = 0 Then MapSize.Width = 100
    If MapSize.Height = 0 Then MapSize.Height = 100
    ...
    With MH
        ...
        If .NumeroBloqueados > 0 Then
            ...
            For i = 1 To .NumeroBloqueados
                MapData(rrX(Blqs(i).x), rrY(Blqs(i).y)).Blocked = Blqs(i).lados
            Next i
        End If
        ...
        If .NumeroLayers(2) > 0 Then
            ...
            For i = 1 To .NumeroLayers(2)
                ...
                MapData(rrX(x), rrY(y)).Graphic(2).GrhIndex = L2(i).GrhIndex
                
                InitGrh MapData(rrX(x), rrY(y)).Graphic(2), MapData(rrX(x), rrY(y)).Graphic(2).GrhIndex
                
                MapData(rrX(x), rrY(y)).Blocked = MapData(rrX(x), rrY(y)).Blocked Or FLAG_COSTA
        ...
        If .NumeroLayers(3) > 0 Then
            ...
            For i = 1 To .NumeroLayers(3)
                ...
                MapData(rrX(x), rrY(y)).Graphic(3).GrhIndex = L3(i).GrhIndex
            
                InitGrh MapData(rrX(x), rrY(y)).Graphic(3), MapData(rrX(x), rrY(y)).Graphic(3).GrhIndex

                If EsArbol(L3(i).GrhIndex) Then
                    MapData(rrX(x), rrY(y)).Blocked = MapData(rrX(x), rrY(y)).Blocked Or FLAG_ARBOL
                End If
            Next i
        ...
        If .NumeroTriggers > 0 Then
            ...
            For i = 1 To .NumeroTriggers
                ...
                ElseIf Triggers(i).Trigger = eTrigger.DETALLEAGUA Or Triggers(i).Trigger = eTrigger.VALIDONADO Or Triggers(i).Trigger = eTrigger.NADOCOMBINADO Then
                    ' Borro flag de costa
                    MapData(rrX(Triggers(i).x), rrY(Triggers(i).y)).Blocked = MapData(rrX(Triggers(i).x), rrY(Triggers(i).y)).Blocked And Not FLAG_COSTA
                End If
            Next i
...
Public Sub CargarParticulas()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "particles.ini", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        StreamFile = RESOURCES_PATH & "/INIT/particles.ini"
    #End If
...
Public Sub CargarParticulasBinary()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "particles.ind", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        StreamFile = RESOURCES_PATH & "/INIT/particles.ind"
    #End If
...
Public Sub CargarIndicesOBJ()
    ...
    #If Compresion = 1 Then
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "localindex.dat", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        ObjFile = RESOURCES_PATH & "/INIT/localindex.dat"
    #End If
    
            
    Dim Leer As New clsIniManager
    If Not FileExist(ObjFile, vbNormal) Then
        MsgBox "No se encuentra " & ObjFile, vbCritical
        End
    End If
...
Public Sub Cargarmapsworlddata()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "mapsworlddata.dat", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        MapFile = RESOURCES_PATH & "/INIT/mapsworlddata.dat"
    #End If
...
Sub CargarMoldes()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "moldes.ini", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Call Loader.Initialize(RESOURCES_PATH & "/INIT/moldes.ini")
    #End If
...
Sub CargarCabezas()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "cabezas.ind", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Open RESOURCES_PATH & "/INIT/cabezas.ind" For Binary Access Read As #n
    #End If
...
Sub CargarCascos()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "cascos.ind", Windows_Temp_Dir, ResourcesPassword, False) Then
            err.Description = "¡No se puede cargar el archivo de Cabezas.ind!"
            MsgBox err.Description
    ...
    #Else
        Open RESOURCES_PATH & "/INIT/cascos.ind" For Binary Access Read As #n
    #End If
...
Sub CargarCuerpos()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "cuerpos.dat", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Call Loader.Initialize(RESOURCES_PATH & "/INIT/cuerpos.dat")
    #End If
...
Sub CargarFxs()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "fxs.ind", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Open RESOURCES_PATH & "/INIT/fxs.ind" For Binary Access Read As #n
    #End If
...
Public Function LoadGrhData() As Boolean
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "graficos.ind", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Open RESOURCES_PATH & "/INIT/graficos.ind" For Binary Access Read As #handle
    #End If
...
Public Sub LoadGrhIni()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "Graficos.ini", Windows_Temp_Dir, ResourcesPassword, False) Then
            err.Description = "¡No se puede cargar el archivo de recurso!"
            GoTo hErr
        End If
    ...
    #Else
        Open RESOURCES_PATH & "/INIT/Graficos.ini" For Input As #FileHandle
    #End If
...
hErr:
    ...
    If err.Number <> 0 Then
        ...
        If err.Number = 53 Then
            Call MsgBox("El archivo Graficos.ini no existe. Por favor, reinstale el juego.", , "Argentum World")
        
        ElseIf grh > 0 Then
            Call MsgBox("Hay un error en Graficos.ini con el Grh" & grh & ".", , "Argentum World")
        
        Else
            Call MsgBox("Hay un error en Graficos.ini. Por favor, reinstale el juego.", , "Argentum World")
        End If
...
Sub CargarAnimArmas()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "armas.dat", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Call Loader.Initialize(RESOURCES_PATH & "/INIT/armas.dat")
    #End If
...
Sub CargarColores()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "colores.dat", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        archivoC = RESOURCES_PATH & "/INIT/colores.dat"
    #End If
...
Sub CargarCrafteo()
    ...
    #If Compresion = 1 Then
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "crafteo.ini", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        FileName = RESOURCES_PATH & "/INIT/crafteo.ini"
    #End If
...
Sub CargarAnimEscudos()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, RESOURCES_PATH & "/OUTPUT/", "escudos.dat", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Call Loader.Initialize(RESOURCES_PATH & "/INIT/escudos.dat")
    #End If
...
Function LoadFont(Name As String) As Boolean
    ...
    LoadFont = AddFontResourceEx(RESOURCES_PATH & "/OUTPUT/" & Name, FR_PRIVATE, 0&) <> 0

    If Not YaMostreError And Not LoadFont Then
        Call MsgBox("No se pudieron cargar algunas fuentes, reinstale el juego para repararlas.", vbOKOnly, "Error al cargar - ArgentumWorld")
        YaMostreError = True
    End If
End Function
...
Public Sub CargarNPCsMapData()
    ...
    Open RESOURCES_PATH & "/OUTPUT/QuestNPCsMapData.bin" For Binary As fh
