...
On Local Error GoTo ErrHandler
    ...
    Select Case file_type
        ...
        Case wav
            SourceFilePath = "Sounds"
        
        Case Scripts
            SourceFilePath = "init"
        
        Case interface
            SourceFilePath = "Interface"
            
        Case Maps
            SourceFilePath = "Mapas"
            
        Case MiniMaps
            SourceFilePath = "MiniMapas"
    ...
    If UseOutputFolder Then
        SourceFilePath = resource_path & OUTPUT_PATH & SourceFilePath
    Else
        SourceFilePath = resource_path & SourceFilePath
    End If
    
    MsgBox SourceFilePath & file_name
...
Public Function GAeneral_Load_Picture_From_Resource(ByVal picture_file_name As String, ByVal Passwd As String) As IPicture
    ...
    If Extract_File(interface, RESOURCES_PATH & "/OUTPUT", picture_file_name, Windows_Temp_Dir, Passwd, False) Then
...
Public Function General_Load_Picture_From_Resource_Ex(ByVal picture_file_name As String, ByVal Passwd As String) As IPicture
    ...
    If Extract_File_To_Memory(interface, RESOURCES_PATH & "/OUTPUT", picture_file_name, bytArr(), Passwd) Then
...
Public Function General_Load_Minimap_From_Resource_Ex(ByVal picture_file_name As String, ByVal Passwd As String) As IPicture
    ...
    If Extract_File_To_Memory(MiniMaps, RESOURCES_PATH & "/OUTPUT", picture_file_name, bytArr(), Passwd) Then
