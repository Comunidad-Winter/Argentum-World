...
Public ComboCooldownTime As Long
Public StartComboCooldownTime As Long
...
Public console_color1(3) As RGBA
Public console_color2(3) As RGBA

Public minimapa_visible As Boolean
Public minimapa_alpha As Single
...
Public LLamadaDeclanx As Integer

Public LLamadaDeclany As Integer
...
Public Entradax As Integer

Public Entraday As Integer
...
Public MouseMapX As Integer
Public MouseMapY As Integer
Public MouseZona As Integer
...
Public CuentaNombre As String
Public CuentaApellido As String

Public ValidacionCode As String

'Objetos públicos

Public ConsoleDialog As clsConsoleDlg
Public Minimap       As clsMinimap
...
Public UserSkillsAssigned(1 To NUMSKILLS)        As Byte
...
Public color_minimap(3) As RGBA
