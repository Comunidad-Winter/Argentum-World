...
Private Sub btnCreateAccount_Click()
    ...
    CuentaNombre = txtName.Text
    
    If Not isValidEmail(CuentaEmail) Then
        Call TextoAlAsistente("El e-mail no parece valido!")
        Exit Sub
    ElseIf Len(CuentaPassword) < 4 Then
        Call TextoAlAsistente("La contraseña es muy corta!")
        Exit Sub
    End If
    
    Call TextoAlAsistente("Creando cuenta...")
