...
cmd_Click_Err:
        MsgBox err.Description & vbCrLf & "in ArgentumWorld.frmPanelgm.cmd_Click " & "at line " & Erl, vbExclamation + vbOKOnly, "Application Error"
        Resume Next
...
Private Sub cmdTarget_Click()
    ...
    'Call AddToConsole(  "Haz click sobre el personaje...", 100, 100, 120, 0, 0)
...
Private Sub mnuManual_Click()
    ...
    Nick = ReadField(1, List1.List(List1.ListIndex), Asc("("))
    Call ParseUserCommand("/MENSAJEINFORMACION " & Nick & "@" & "Su consulta fue rechazada debido a que la respuesta se encuentra en el Manual o FAQ de nuestra pagina web. Para mas información visite: www.argentumworld?.com.ar.")
