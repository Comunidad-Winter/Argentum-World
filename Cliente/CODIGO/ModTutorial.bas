...
Public Sub toggleTutorialActivo(ByVal tutorial_index As Byte)
    ...
    With tutorial(tutorial_index)
        ...
        file = RESOURCES_PATH & "/OUTPUT/configuracion.ini"
...
Public Sub cargarTutoriales()
    ...
    FileName = RESOURCES_PATH & "/OUTPUT/Configuracion.ini"
...
Public Sub checkTutorial()
    ...
    If charlist(UserCharIndex).Pos.x > 10 And charlist(UserCharIndex).Pos.y > 10 And charlist(UserCharIndex).Pos.x < 80 And charlist(UserCharIndex).Pos.y < 80 Then
        ...
        If Not mascota.visible Then
            ...
            mascota.dialog = "Bienvenido, soy tu guia de entrenamiento en las tierras de Argentum World, estaré siguiendo todos tus movimientos para que te conviertas en un enorme guerrero."
        ...
        '        mascota.visible = True
        '        Call mostrarCartel(tutorial(tutorial_index).titulo, tutorial(tutorial_index).textos(1), 275, -1, &H164B8A, , , False, 100, 629, 100, 685, 640, 490, 64, 64)
        '    End If
        'End If
    Else
