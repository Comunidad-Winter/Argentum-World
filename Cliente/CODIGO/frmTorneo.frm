...
Private Sub Command1_Click()
    ...
    Call WriteCreaerTorneo(nivelmin, nivelmax, cupos, costo.Text, Check1.Value, Check2.Value, Check3.Value, Check4.Value, Check5.Value, Check6.Value, Check7.Value, Check8.Value, Check10.Value, Check11.Value, Check12.Value, map, x, y, nombre, reglas)
