...
Public Sub Iniciar_Labels()
    ...
    For i = 1 To NUMSKILLS
        ...
        Text2(i).Caption = UserSkillsAssigned(i)
    Next
    ...
    If (Index And &H1) = 0 Then
        If Alocados > 0 Then
            ...
            If Val(Text1(indice).Caption) < MAXSKILLPOINTS Then
                ...
                Text2(indice).Caption = Val(Text2(indice).Caption) + 1
...
Private Sub command1_MouseUp(Index As Integer, Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    Set Command1(Index).Picture = Nothing
...
Private Sub Form_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    For A = Command1.LBound To Command1.UBound
...
Private Sub skills_Click(Index As Integer)
    ...
    AddToConsole "Información del skill> " & SkillsDesc(Index), 2, 51, 223, 1, 1
