...
Public Sub SetLanguageApplication()
    ...
    Localization = GetVar(RESOURCES_PATH & "/OUTPUT/Configuracion.ini", "OPCIONES", "Localization")
    ...
    If LenB(Localization) = 0 Then
        ...
        Call WriteVar(RESOURCES_PATH & "/OUTPUT/Configuracion.ini", "OPCIONES", "Localization", language)
    Else
