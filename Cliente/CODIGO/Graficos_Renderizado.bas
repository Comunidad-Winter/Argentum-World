...
Sub RenderScreenCiego(ByVal tilex As Integer, ByVal tiley As Integer, ByVal PixelOffsetX As Integer, ByVal PixelOffsetY As Integer)
    ...
    For y = screenminY To screenmaxY
        For x = screenminX To screenmaxX
            'Layer 1 **********************************
            Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(1), (ScreenX - 1) * 32 + PixelOffsetX, (ScreenY - 1) * 32 + PixelOffsetY, 0, 1, ColorCiego, , x, y)
            '******************************************
            ScreenX = ScreenX + 1
        Next x
        ...
        For y = minY To MaxY
            ...
            For x = minX To MaxX
                ...
                With MapData(rrX(x), rrY(y))
                    ...
                    '***********************************************
                    If MapData(rrX(x), rrY(y)).Graphic(2).GrhIndex <> 0 Then
                        Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(2), (ScreenX * 32 + PixelOffsetX), (ScreenY * 32 + PixelOffsetY), 1, 1, ColorCiego, , x, y)
    ...
    For y = minY To MaxY
        ...
        For x = minX To MaxX
            ...
            With MapData(rrX(x), rrY(y))
                ...
                'Object Layer **********************************
                If MapData(rrX(x), rrY(y)).ObjGrh.GrhIndex <> 0 Then
                    Call Draw_Grh(MapData(rrX(x), rrY(y)).ObjGrh, (ScreenX * 32 + PixelOffsetX), (ScreenY * 32 + PixelOffsetY), 1, 1, ColorCiego, , x, y)
                ...
                If MapData(rrX(x), rrY(y)).charindex = UserCharIndex Then
                    If x <> UserPos.x Then
                        MapData(rrX(x), rrY(y)).charindex = 0
    ...
    If HayLayer4 Then
        ...
        For y = minY To MaxY
            ...
            For x = minX To MaxX
                ...
                If MapData(rrX(x), rrY(y)).Graphic(4).GrhIndex Then
        
                    'Layer 4 **********************************
                    If bTecho Then

                        If MapData(rrX(UserPos.x), rrY(UserPos.y)).Trigger = MapData(rrX(x), rrY(y)).Trigger Then
                    
                            If MapData(rrX(x), rrY(y)).GrhBlend <= 20 Then MapData(rrX(x), rrY(y)).GrhBlend = 20
                            MapData(rrX(x), rrY(y)).GrhBlend = MapData(rrX(x), rrY(y)).GrhBlend - (timerTicksPerFrame * 12)
                    
                            rgb_list(0) = D3DColorARGB(CInt(MapData(rrX(x), rrY(y)).GrhBlend), ColorAmbiente.r, ColorAmbiente.g, ColorAmbiente.b)
                            rgb_list(1) = rgb_list(0)
                            rgb_list(2) = rgb_list(0)
                            rgb_list(3) = rgb_list(0)
                        
                            Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(4), ScreenX * 32 + PixelOffsetX, ScreenY * 32 + PixelOffsetY, 1, 1, ColorCiego, , x, y)
                        Else
                            Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(4), ScreenX * 32 + PixelOffsetX, ScreenY * 32 + PixelOffsetY, 1, 1, ColorCiego, , x, y)
                    ...
                    Else
                        ...
                        If MapData(rrX(x), rrY(y)).GrhBlend >= 255 Then MapData(rrX(x), rrY(y)).GrhBlend = 255
...
Sub RenderScreen(ByVal tilex As Integer, ByVal tiley As Integer, ByVal PixelOffsetX As Integer, ByVal PixelOffsetY As Integer)
    ...
    For y = screenminY To screenmaxY
        For x = screenminX To screenmaxX
            ...
            'Layer 1 **********************************
            Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(1), (ScreenX - 1) * 32 + PixelOffsetX, (ScreenY - 1) * 32 + PixelOffsetY, 0, 1, MapData(rrX(x), rrY(y)).light_value, , x, y)
            '******************************************
            ScreenX = ScreenX + 1
        Next x
        ...
        For y = minY To MaxY ' el -8 lo agrego
            ...
            For x = minX To MaxX  ' -7 lo agrego
                ...
                With MapData(rrX(x), rrY(y))
                    ...
                    '***********************************************
                    If MapData(rrX(x), rrY(y)).Graphic(2).GrhIndex <> 0 Then
                        Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(2), (ScreenX * 32 + PixelOffsetX), (ScreenY * 32 + PixelOffsetY), 1, 1, MapData(rrX(x), rrY(y)).light_value(), , x, y)
    ...
    For y = minY To MaxY
        ...
        For x = minX To MaxX
            ...
            With MapData(rrX(x), rrY(y))
                ...
                'Object Layer **********************************
                If MapData(rrX(x), rrY(y)).ObjGrh.GrhIndex <> 0 Then
                    Call Draw_Grh(MapData(rrX(x), rrY(y)).ObjGrh, PixelOffsetXTemp, PixelOffsetYTemp, 1, 1, MapData(rrX(x), rrY(y)).light_value(), , x, y)
                ...
                If .CharFantasma.Activo Then
                    ...
                    If MapData(rrX(x), rrY(y)).CharFantasma.AlphaB >= 3 Then
                        MapData(rrX(x), rrY(y)).CharFantasma.AlphaB = MapData(rrX(x), rrY(y)).CharFantasma.AlphaB - (timerTicksPerFrame * 6.7)
                        ColorFantasma(0) = D3DColorARGB(CInt(MapData(rrX(x), rrY(y)).CharFantasma.AlphaB), ColorAmbiente.r, ColorAmbiente.g, ColorAmbiente.b)
                ...
                'Layer 3 *****************************************
                If .Graphic(3).GrhIndex <> 0 Then
                    Call Draw_Grh(.Graphic(3), PixelOffsetXTemp, PixelOffsetYTemp, 1, 1, MapData(rrX(x), rrY(y)).light_value, False, x, y)
                ...
                If MapData(rrX(x), rrY(y)).Graphic(4).GrhIndex Then
                    ...
                    If bTecho Then
                        If MapData(rrX(UserPos.x), rrY(UserPos.y)).Trigger = MapData(rrX(x), rrY(y)).Trigger Then
                            ...
                            rgb_list(0) = D3DColorARGB(CInt(MapData(rrX(x), rrY(y)).GrhBlend), b, g, r)
                            rgb_list(1) = rgb_list(0)
                            rgb_list(2) = rgb_list(0)
                            rgb_list(3) = rgb_list(0)
                        
                            Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(4), ScreenX * 32 + PixelOffsetX, ScreenY * 32 + PixelOffsetY, 1, 1, rgb_list(), , x, y)
                        Else
                            Call Draw_Grh(MapData(rrX(x), rrY(y)).Graphic(4), ScreenX * 32 + PixelOffsetX, ScreenY * 32 + PixelOffsetY, 1, 1, rgb_list2(), , x, y)
    ...
    For y = minY To MaxY
        ...
        For x = minX To MaxX
            ...
            With MapData(rrX(x), rrY(y))
                ...
                If MapData(rrX(x), rrY(y)).charindex <> 0 Then
                    If charlist(MapData(rrX(x), rrY(y)).charindex).active = 1 Then
                        Call Char_TextRender(MapData(rrX(x), rrY(y)).charindex, PixelOffsetXTemp, PixelOffsetYTemp, x, y)
    ...
    With charlist(charindex)
        ...
        If .Body.Walk(.Heading).GrhIndex Then
            ...
            If Not .invisible Then
                ...
                colorz(0) = MapData(rrX(x), rrY(y)).light_value(0)
                colorz(1) = MapData(rrX(x), rrY(y)).light_value(1)
                colorz(2) = MapData(rrX(x), rrY(y)).light_value(2)
                colorz(3) = MapData(rrX(x), rrY(y)).light_value(3)
...
Private Sub Char_TextRender(ByVal charindex As Long, ByVal PixelOffsetX As Integer, ByVal PixelOffsetY As Integer, ByVal x As Byte, ByVal y As Byte)
    ...
    With charlist(charindex)
        ...
        '*** Start Dialogs ***
        If charlist(MapData(rrX(x), rrY(y)).charindex).dialog <> "" Then
            ...
            PixelY = PixelOffsetY
            temp_array(0) = charlist(MapData(rrX(x), rrY(y)).charindex).dialog_color
            temp_array(1) = temp_array(0)
            temp_array(2) = temp_array(0)
            temp_array(3) = temp_array(0)

            If charlist(MapData(rrX(x), rrY(y)).charindex).dialog_scroll Then
                charlist(MapData(rrX(x), rrY(y)).charindex).dialog_offset_counter_y = charlist(MapData(rrX(x), rrY(y)).charindex).dialog_offset_counter_y + (scroll_dialog_pixels_per_frame * timerTicksPerFrame * Sgn(-1))

                If Sgn(charlist(MapData(rrX(x), rrY(y)).charindex).dialog_offset_counter_y) = -1 Then
                    charlist(MapData(rrX(x), rrY(y)).charindex).dialog_offset_counter_y = 0
                    charlist(MapData(rrX(x), rrY(y)).charindex).dialog_scroll = False

                End If

                Engine_Text_Render charlist(MapData(rrX(x), rrY(y)).charindex).dialog, PixelOffsetX + 14 - CInt(Engine_Text_Width(charlist(MapData(rrX(x), rrY(y)).charindex).dialog, True) / 2), PixelY + charlist(MapData(rrX(x), rrY(y)).charindex).Body.HeadOffset.y - Engine_Text_Height(charlist(MapData(rrX(x), rrY(y)).charindex).dialog, True) + charlist(MapData(rrX(x), rrY(y)).charindex).dialog_offset_counter_y, temp_array, 1, True, MapData(rrX(x), rrY(y)).charindex
            Else
                Engine_Text_Render charlist(MapData(rrX(x), rrY(y)).charindex).dialog, PixelOffsetX + 14 - CInt(Engine_Text_Width(charlist(MapData(rrX(x), rrY(y)).charindex).dialog, True) / 2), PixelY + charlist(MapData(rrX(x), rrY(y)).charindex).Body.HeadOffset.y - Engine_Text_Height(charlist(MapData(rrX(x), rrY(y)).charindex).dialog, True), temp_array, 1, True, MapData(rrX(x), rrY(y)).charindex

            End If

        End If
        
        If charlist(MapData(rrX(x), rrY(y)).charindex).dialogEfec <> "" Then

            charlist(MapData(rrX(x), rrY(y)).charindex).SubeEfecto = charlist(MapData(rrX(x), rrY(y)).charindex).SubeEfecto - timerTicksPerFrame
            charlist(MapData(rrX(x), rrY(y)).charindex).dialog_Efect_color.a = charlist(MapData(rrX(x), rrY(y)).charindex).dialog_Efect_color.a - (timerTicksPerFrame * 8.2)

            If charlist(MapData(rrX(x), rrY(y)).charindex).dialog_Efect_color.a < 0 Then
                charlist(MapData(rrX(x), rrY(y)).charindex).SubeEfecto = 0
                charlist(MapData(rrX(x), rrY(y)).charindex).dialogEfec = ""
            Else
                ...
                Engine_Text_Render_Efect MapData(rrX(x), rrY(y)).charindex, .dialogEfec, PixelOffsetX + 14 - Engine_Text_Width(.dialogEfec, True) / 2, PixelOffsetY - 100 + .Body.HeadOffset.y - Engine_Text_Height(.dialogEfec, True) + .SubeEfecto, temp_array, 1, True, max(CDbl(charlist(MapData(rrX(x), rrY(y)).charindex).dialog_Efect_color.a), 0)

            End If

        End If
            
        ' If charlist(MapData(rrX(X), rrY(Y)).charindex).dialogExp <> "" Then
    
        '  charlist(MapData(rrX(X), rrY(Y)).charindex).SubeExp = charlist(MapData(rrX(X), rrY(Y)).charindex).SubeExp + (5 * timerTicksPerFrame * Sgn(-1))
        ' If charlist(MapData(rrX(X), rrY(Y)).charindex).SubeExp <= 5 Then
        '   charlist(MapData(rrX(X), rrY(Y)).charindex).SubeExp = 0
        '  charlist(MapData(rrX(X), rrY(Y)).charindex).dialogExp = ""
        'End If
                    
        'temp_array(0) = D3DColorARGB(charlist(MapData(rrX(X), rrY(Y)).charindex).SubeExp, 42, 169, 222)
        ' temp_array(1) = temp_array(0)
        ' temp_array(2) = temp_array(0)
        ' temp_array(3) = temp_array(0)
        'Engine_Text_Render_Exp MapData(rrX(X), rrY(Y)).charindex, .dialogExp, PixelOffsetX + 14 - Engine_Text_Width(.dialogExp, True) / 2, PixelOffsetY + 14 + .Body.HeadOffset.Y - Engine_Text_Height(.dialogExp, True), temp_array, 1, True
        ' End If
            
        'If charlist(MapData(rrX(X), rrY(Y)).charindex).dialogOro <> "" Then

        '  charlist(MapData(rrX(X), rrY(Y)).charindex).SubeOro = charlist(MapData(rrX(X), rrY(Y)).charindex).SubeOro + (5 * timerTicksPerFrame * Sgn(-1))
                
        'If charlist(MapData(rrX(X), rrY(Y)).charindex).SubeOro <= 5 Then
        '    charlist(MapData(rrX(X), rrY(Y)).charindex).SubeOro = 0
        '    charlist(MapData(rrX(X), rrY(Y)).charindex).dialogOro = ""
        'End If
                
        ' temp_array(0) = D3DColorARGB(charlist(MapData(rrX(X), rrY(Y)).charindex).SubeOro, 255, 255, 115)
        ' temp_array(1) = temp_array(0)
        ' temp_array(2) = temp_array(0)
        ' temp_array(3) = temp_array(0)
        ' Engine_Text_Render_Exp MapData(rrX(X), rrY(Y)).charindex, .dialogOro, PixelOffsetX + 14 - Engine_Text_Width(.dialogOro, True) / 2, PixelOffsetY + 1 + .Body.HeadOffset.Y - Engine_Text_Height(.dialogOro, True), temp_array, 1, True
    ...
    For y = minY To MaxY
        ...
        For x = minX To MaxX
            ...
            With MapData(rrX(x), rrY(y))
                ...
                'Object Layer **********************************
                If MapData(rrX(x), rrY(y)).ObjGrh.GrhIndex <> 0 Then
                    Call Draw_Grh(MapData(rrX(x), rrY(y)).ObjGrh, (ScreenX * 32 + PixelOffsetX), (ScreenY * 32 + PixelOffsetY), 1, 1, MapData(rrX(x), rrY(y)).light_value(), , x, y)
