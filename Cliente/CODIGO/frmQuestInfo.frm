        ...
        lblRepetible.visible = QuestList(QuestIndex).Repetible = 1
                ...
                'tmpStr = tmpStr & "Nivel requerido: " & .ReadByte & vbCrLf
                  ...
                  If QuestList(QuestIndex).RequiredQuest <> 0 Then
                    FrmQuestInfo.Text1.Text = ""
                    Call AddToConsole(Text1, QuestList(QuestIndex).desc & vbCrLf & vbCrLf & "Requisitos: " & vbCrLf & "Nivel requerido: " & QuestList(QuestIndex).RequiredLevel & vbCrLf & "Quest: " & QuestList(QuestList(QuestIndex).RequiredQuest).nombre, 128, 128, 128)
                Else
                    FrmQuestInfo.Text1.Text = ""
                    Call AddToConsole(Text1, QuestList(QuestIndex).desc & vbCrLf & vbCrLf & "Requisitos: " & vbCrLf & "Nivel requerido: " & QuestList(QuestIndex).RequiredLevel & vbCrLf, 128, 128, 128)
...
FrmQuestInfo.ListView1.ListItems.Clear
                ...
                FrmQuestInfo.Text1.Text = ""
                Call AddToConsole(Text1, QuestList(QuestIndex).desc & vbCrLf & "Nivel requerido: " & QuestList(QuestIndex).RequiredLevel & vbCrLf, 128, 128, 128)
                'tmpStr = tmpStr & "Detalles: " & .ReadASCIIString & vbCrLf
                'tmpStr = tmpStr & "Nivel requerido: " & .ReadByte & vbCrLf
