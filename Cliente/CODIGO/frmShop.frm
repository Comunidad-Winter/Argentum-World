...
Private Sub Image3_Click()
    ...
    Else
        Call AddToConsole("No tienes suficientes créditos para comprar ese elemento. Puedes comprar más créditos a través del siguiente link: https://www.patreon.com/nolandstudios", 255, 0, 0, True)
    End If
End Sub
