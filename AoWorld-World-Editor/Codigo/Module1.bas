...
Public Sub CargarParticulasBinary()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "particles.ind", Windows_Temp_Dir, False) Then
    ...
    #Else
        StreamFile = App.Path & "\..\Resources\init\particles.ind"
    #End If
...
Public Sub CargarParticulas()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "particles.ini", Windows_Temp_Dir, False) Then
