...
Public Sub CargarIndicesDeGraficos()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "Graficos.ini", Windows_Temp_Dir, ResourcesPassword, False) Then
    ...
    #Else
        Open App.Path & "\..\Resources\init\Graficos.ini" For Input As #FileHandle
    #End If
...
hErr:
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT", "minimap.bin", Windows_Temp_Dir, False) Then
    ...
    #Else
        Open App.Path & "\..\Resources\init\minimap.bin" For Binary Access Read As #FileHandle
    #End If
...
Public Sub CargarIndicesDeGraficosIND()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "graficos.ind", Windows_Temp_Dir, False) Then
            Err.Description = "¡No se puede cargar el archivo de recurso!"
            GoTo ErrorHandler
    ...
    #Else
        Open App.Path & "\..\Resources\init\graficos.ind" For Binary Access Read As #handle
    #End If
    ...
    #Else
        Open App.Path & "\..\Resources\init\minimap.bin" For Binary Access Read As #handle
    #End If
...
Sub CargarMoldes()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "moldes.ini", Windows_Temp_Dir, False) Then
    ...
    #Else
        Call Loader.Initialize(App.Path & "\..\Resources\init\moldes.ini")
    #End If
...
Public Sub CargarIndicesSuperficie()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT", "indices.ini", Windows_Temp_Dir, False) Then
    ...
    #Else
        FileDir = App.Path & "\..\Resources\init\indices.ini"
    #End If
...
Public Sub CargarIndicesOBJ()
    ...
    If FileExist(App.Path & "\..\Resources\dat\OBJ.dat", vbArchive) = False Then
    ...
    Dim Obj  As Integer
    Dim Leer As New clsIniReader
    Call Leer.Initialize(App.Path & "\..\Resources\dat\OBJ.dat")
...
Public Sub CargarIndicesTriggers()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT", "triggers.ini", Windows_Temp_Dir, False) Then
    ...
    #Else
        FileDir = App.Path & "\..\Resources\init\triggers.ini"
    #End If
...
Public Sub CargarIndicesDeCuerpos()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "cuerpos.dat", Windows_Temp_Dir, False) Then
    ...
    #Else
        Call Loader.Initialize(App.Path & "\..\Resources\init\cuerpos.dat")
    #End If
...
Public Sub CargarIndicesDeCabezas()
    ...
    #If Compresion = 1 Then
        ...
        If Not Extract_File(Scripts, App.Path & "\..\Resources\OUTPUT\", "cabezas.ind", Windows_Temp_Dir, False) Then
    ...
    #Else
        Open App.Path & "\..\Resources\init\cabezas.ind" For Binary Access Read As #n
    #End If
...
Public Sub CargarIndicesNPC()
    ...
    'On Error GoTo Fallo
    If FileExist(App.Path & "\..\Resources\dat\" & "\NPCs.dat", vbArchive) = False Then
        MsgBox "Falta el archivo 'NPCs.dat' en " & App.Path & "\..\Resources\dat\", vbCritical
        End
    ...
    Call Leer.Initialize(App.Path & "\..\Resources\dat\" & "\NPCs.dat")
    ...
    For NPC = 1 To NumNPCs
        ...
        NpcData(NPC).Hostile = IIf(Val(Leer.GetValue("NPC" & NPC, "Attackable")) = 1 And Val(Leer.GetValue("NPC" & NPC, "OrigPos")) = 0, 1, 0)
        
        If NPC = 602 Or NPC = 1027 Then
            NpcData(NPC).Hostile = 0
        End If
