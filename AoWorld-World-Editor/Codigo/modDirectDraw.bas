...
Function NextOpenChar() As Integer
    ...
    Do While CharList(loopc).active
        loopc = loopc + 1
        If loopc > UBound(CharList) Then Exit Do
    Loop
    
    If loopc > UBound(CharList) Then
        ReDim Preserve CharList(1 To loopc)
    End If
...
Function LegalPos(X As Integer, Y As Integer) As Boolean
    ...
    If X > MapSize.Width Or X < 1 Then Exit Function
    If Y > MapSize.Height Or Y < 1 Then Exit Function
...
Public Sub PegarSeleccion() '(mx As Integer, my As Integer)
    ...
    Dim grhLayer1 As Grh
    Dim grhLayer2 As Grh
    Dim grhLayer3 As Grh
    Dim grhLayer4 As Grh
    ...
    Call modEdicion.Deshacer_Add(SobreX, SobreY, SeleccionAncho, SeleccionAlto)
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
            ...
            If Not FrmMain.mmCopiarCapa1.Checked Then
                grhLayer1 = MapData(X + SobreX, Y + SobreY).Graphic(1)
            End If
            If Not FrmMain.mmCopiarCapa2.Checked Then
                grhLayer2 = MapData(X + SobreX, Y + SobreY).Graphic(2)
            End If
            If Not FrmMain.mmCopiarCapa3.Checked Then
                grhLayer3 = MapData(X + SobreX, Y + SobreY).Graphic(3)
            End If
            If Not FrmMain.mmCopiarCapa4.Checked Then
                grhLayer4 = MapData(X + SobreX, Y + SobreY).Graphic(4)
            End If
            ...
            If Not FrmMain.mmCopiarCapa1.Checked Then
                MapData(X + SobreX, Y + SobreY).Graphic(1) = grhLayer1
            End If
            If Not FrmMain.mmCopiarCapa2.Checked Then
                MapData(X + SobreX, Y + SobreY).Graphic(2) = grhLayer2
            End If
            If Not FrmMain.mmCopiarCapa3.Checked Then
                MapData(X + SobreX, Y + SobreY).Graphic(3) = grhLayer3
            End If
            If Not FrmMain.mmCopiarCapa4.Checked Then
                MapData(X + SobreX, Y + SobreY).Graphic(4) = grhLayer4
            End If
...
Public Sub RenderSeleccion() '(mx As Integer, my As Integer)
...
End Sub
Public Sub PegarSeleccionCapa1()

    On Error GoTo PegarSeleccionCapa1_Err
    ...
    For X = 0 To DeSeleccionAncho - 1
        For Y = 0 To DeSeleccionAlto - 1
            ...
            If Y + SobreY > MapSize.Height Then Exit For
            If X + SobreX > MapSize.Width Then Exit For
            DeSeleccionMap(X, Y).OBJInfo.ObjIndex = MapData(X + SobreX, Y + SobreY).OBJInfo.ObjIndex
            DeSeleccionMap(X, Y).OBJInfo.Amount = MapData(X + SobreX, Y + SobreY).OBJInfo.Amount
            DeSeleccionMap(X, Y).ObjGrh.grhindex = MapData(X + SobreX, Y + SobreY).ObjGrh.grhindex
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
            ...
            SeleccionMap(X, Y).TileExit.X = MapData(X + SobreX, Y + SobreY).TileExit.X
            SeleccionMap(X, Y).TileExit.Y = MapData(X + SobreX, Y + SobreY).TileExit.Y
            SeleccionMap(X, Y).OBJInfo.ObjIndex = MapData(X + SobreX, Y + SobreY).OBJInfo.ObjIndex
            SeleccionMap(X, Y).OBJInfo.Amount = MapData(X + SobreX, Y + SobreY).OBJInfo.Amount
            SeleccionMap(X, Y).ObjGrh.grhindex = MapData(X + SobreX, Y + SobreY).ObjGrh.grhindex
        
            MapData(X + SobreX, Y + SobreY).Graphic(1).grhindex = SeleccionMap(X, Y).Graphic(1).grhindex
            MapData(X + SobreX, Y + SobreY).NpcIndex = 0
        Next
    Next
    MapInfo.Changed = 1
    'Seleccionando = False
...
PegarSeleccionCapa1_Err:
    Call RegistrarError(Err.Number, Err.Description, "modDirectDraw.PegarSeleccionCapa1", Erl)
    Resume Next
    
End Sub
Public Sub PegarSeleccionCapa2()
    
    On Error GoTo PegarSeleccionCapa2_Err
    ...
    For X = 0 To DeSeleccionAncho - 1
        For Y = 0 To DeSeleccionAlto - 1
            ...
            DeSeleccionMap(X, Y).Graphic(1).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(1).grhindex
'            DeSeleccionMap(X, y).Graphic(3).grhindex = MapData(X + SobreX, y + SobreY).Graphic(3).grhindex
            'DeSeleccionMap(X, Y).Graphic(4).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(4).grhindex
            ...
            MapData(X + SobreX, Y + SobreY).NpcIndex = 0
            MapData(X + SobreX, Y + SobreY).Blocked = 0
        Next
    Next
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
            ...
            SeleccionMap(X, Y).Graphic(1).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(1).grhindex
'            SeleccionMap(X, y).Graphic(3).grhindex = MapData(X + SobreX, y + SobreY).Graphic(3).grhindex
           ' SeleccionMap(X, Y).Graphic(4).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(4).grhindex
...
PegarSeleccionCapa2_Err:
    Call RegistrarError(Err.Number, Err.Description, "modDirectDraw.PegarSeleccionCapa2", Erl)
    Resume Next
    
End Sub
Public Sub PegarSeleccionCapa3()
    
    On Error GoTo PegarSeleccionCapa3_Err
    ...
    For X = 0 To DeSeleccionAncho - 1
        For Y = 0 To DeSeleccionAlto - 1
            ...
            DeSeleccionMap(X, Y).Graphic(1).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(1).grhindex
'            DeSeleccionMap(X, y).Graphic(2).grhindex = MapData(X + SobreX, y + SobreY).Graphic(2).grhindex
            'DeSeleccionMap(X, Y).Graphic(4).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(4).grhindex
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
            ...
            SeleccionMap(X, Y).Graphic(1).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(1).grhindex
'            SeleccionMap(X, y).Graphic(2).grhindex = MapData(X + SobreX, y + SobreY).Graphic(2).grhindex
            'SeleccionMap(X, Y).Graphic(4).grhindex = MapData(X + SobreX, Y + SobreY).Graphic(4).grhindex
...
PegarSeleccionCapa3_Err:
    Call RegistrarError(Err.Number, Err.Description, "modDirectDraw.PegarSeleccionCapa3", Erl)
    Resume Next
    
End Sub
Public Sub PegarSeleccionCapa4()
    
'    On Error GoTo PegarSeleccionCapa4_Err
'
...
'  Exit Sub
'
'PegarSeleccionCapa4_Err:
'    Call RegistrarError(Err.Number, Err.Description, "modDirectDraw.PegarSeleccionCapa4", Erl)
'    Resume Next
...
Public Sub AccionSeleccion()
    ...
    Call modEdicion.Deshacer_Add(SeleccionIX, SeleccionIY, SeleccionAncho, SeleccionAlto)
    ReDim DeSeleccionMap(DeSeleccionAncho, DeSeleccionAlto) As MapBlock
...
Public Sub CortarSeleccion()
    ...
    If Deshacer Then Call modEdicion.Deshacer_Add(SeleccionIX, SeleccionIY, SeleccionFX, SeleccionFY)
...
Function InitTileEngine(ByRef setDisplayFormhWnd As Long, setMainViewTop As Integer, setMainViewLeft As Integer, setTilePixelHeight As Integer, setTilePixelWidth As Integer, setWindowTileHeight As Integer, setWindowTileWidth As Integer, setTileBufferSize As Integer) As Boolean
    ...
    '[GS] 02/10/2006
    MinXBorder = 1 + (ClienteWidth \ 2)
    MaxXBorder = MapSize.Width - (ClienteWidth \ 2)
    MinYBorder = 1 + (ClienteHeight \ 2)
    MaxYBorder = MapSize.Height - (ClienteHeight \ 2)
