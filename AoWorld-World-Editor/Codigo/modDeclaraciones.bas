...
Public RectanguloModo           As Integer
Public RectanguloX           As Integer
Public RectanguloY           As Integer
Public RectanguloX2           As Integer
Public RectanguloY2           As Integer
...
Public Type MapBlockMagic

    Graphic(1 To 6) As Long
    CharIndex As Integer
    ObjGrh As Grh
...
' Deshacer
Public Const maxDeshacer                                                                          As Integer = 200
Public MapData_Deshacer(maxDeshacer) As MapTile
...
Public MapDataMagic() As MapBlockMagic 'Holds map data for current map

Public MapInfo                                 As MapInfo 'Holds map info for current map
Public CharList()                    As char 'Holds info about all characters on map
...
Public ColorBlanco As Long
Public ColorRojo As Long
Public ColorVerde As Long
Public ColorAmarillo As Long
Public ColorNaranja As Long
Public ColorCian As Long
Public ColorAzul As Long
