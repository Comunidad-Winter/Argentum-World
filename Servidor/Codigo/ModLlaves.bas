...
120                             MapData(.flags.TargetObjMap).Tile(.flags.TargetObjX, .flags.TargetObjY).ObjInfo.ObjIndex = ObjData(MapData(.flags.TargetObjMap).Tile(.flags.TargetObjX, .flags.TargetObjY).ObjInfo.ObjIndex).IndexCerrada
122                             .flags.TargetObj = MapData(.flags.TargetObjMap).Tile(.flags.TargetObjX, .flags.TargetObjY).ObjInfo.ObjIndex
...
130                             MapData(.flags.TargetObjMap).Tile(.flags.TargetObjX, .flags.TargetObjY).ObjInfo.ObjIndex = ObjData(MapData(.flags.TargetObjMap).Tile(.flags.TargetObjX, .flags.TargetObjY).ObjInfo.ObjIndex).IndexCerradaLlave
132                             .flags.TargetObj = MapData(.flags.TargetObjMap).Tile(.flags.TargetObjX, .flags.TargetObjY).ObjInfo.ObjIndex
