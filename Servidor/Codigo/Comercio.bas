...
118         ElseIf Not NpcList(NpcIndex).Invent.Object(Slot).Amount > 0 Then
            ...
            If NpcList(NpcIndex).Invent.Object(Slot).Crucial = 0 Then
...
126         Precio = Ceil(ObjData(Objeto_A_Comprar.ObjIndex).Valor / 2 * Cantidad)
...
134         UserList(UserIndex).Stats.GLD = UserList(UserIndex).Stats.GLD - Precio
            ...
            If Precio >= 50000 Then Call SendCharacterEvent(UserIndex, e_EventType.BuyItem, ObjData(Objeto.ObjIndex).Name, Objeto.ObjIndex, Objeto.Amount, Precio)
...
198         If UserList(UserIndex).Stats.GLD > MAXORO Then UserList(UserIndex).Stats.GLD = MAXORO
            ...
            If Precio >= 30000 Then Call SendCharacterEvent(UserIndex, e_EventType.SellItem, ObjData(Objeto.ObjIndex).Name, Objeto.ObjIndex, Objeto.Amount, Precio)
...
204         If NpcSlot > 0 And NpcSlot <= MAX_INVENTORY_SLOTS Then 'Slot valido
                ...
                If NpcList(NpcIndex).Invent.Object(NpcSlot).Crucial = 0 Then
