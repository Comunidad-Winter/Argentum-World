...
100     Call Writer.WriteInt16(ServerPacketID.AccountCharacterList)
        ...
        For i = 1 To Count
            With Personajes(i)
                ...
                Call Writer.WriteInt16(.cuerpo)
                Call Writer.WriteInt16(.Cabeza)
                Call Writer.WriteInt16(.clase)
                Call Writer.WriteInt16(.Mapa)
                Call Writer.WriteInt16(.PosX)
                Call Writer.WriteInt16(.PosY)
                Call Writer.WriteInt16(.nivel)
                Call Writer.WriteInt8(.Status)
                Call Writer.WriteInt16(.Casco)
                Call Writer.WriteInt16(.Escudo)
                Call Writer.WriteInt16(.Arma)
                Call Writer.WriteInt8(.Privs)
            End With
        Next i
...
WriteAccountCharacterList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteAccountCharacterList", Erl)
        '</EhFooter>
End Sub
' \Begin: [Writes]
...
WriteConnected_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteConnected", Erl)
        '</EhFooter>
End Sub
...
WriteLoggedMessage_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteLoggedMessage", Erl)
        '</EhFooter>
End Sub
...
WriteHora_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteHora", Erl)
        '</EhFooter>
End Sub
...
WriteRemoveAllDialogs_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteRemoveAllDialogs", Erl)
        '</EhFooter>
End Sub
...
WriteRemoveCharDialog_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteRemoveCharDialog", Erl)
        '</EhFooter>
End Sub
...
100     Call Writer.WriteInt16(ServerPacketID.NavigateToggle)
        Call Writer.WriteBool(UserList(UserIndex).flags.Navegando)
102     Call modSendData.SendData(ToIndex, UserIndex)
        '<EhFooter>
        Exit Sub
...
WriteNavigateToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNavigateToggle", Erl)
        '</EhFooter>
End Sub
...
WriteNadarToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNadarToggle", Erl)
        '</EhFooter>
End Sub
...
WriteEquiteToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteEquiteToggle", Erl)
        '</EhFooter>
End Sub
...
WriteVelocidadToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteVelocidadToggle", Erl)
        '</EhFooter>
End Sub
...
WriteMacroTrabajoToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteMacroTrabajoToggle", Erl)
        '</EhFooter>
End Sub
...
WriteDisconnect_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteDisconnect", Erl)
        '</EhFooter>
End Sub
...
WriteCommerceEnd_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCommerceEnd", Erl)
        '</EhFooter>
End Sub
...
WriteBankEnd_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBankEnd", Erl)
        '</EhFooter>
End Sub
...
WriteCommerceInit_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCommerceInit", Erl)
        '</EhFooter>
End Sub
...
WriteBankInit_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBankInit", Erl)
        '</EhFooter>
End Sub
...
WriteUserCommerceInit_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserCommerceInit", Erl)
        '</EhFooter>
End Sub
...
WriteUserCommerceEnd_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserCommerceEnd", Erl)
        '</EhFooter>
End Sub
...
WriteShowBlacksmithForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowBlacksmithForm", Erl)
        '</EhFooter>
End Sub
...
WriteShowCarpenterForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowCarpenterForm", Erl)
        '</EhFooter>
End Sub
...
WriteShowAlquimiaForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowAlquimiaForm", Erl)
        '</EhFooter>
End Sub
...
WriteShowSastreForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowSastreForm", Erl)
        '</EhFooter>
End Sub
...
WriteNPCKillUser_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNPCKillUser", Erl)
        '</EhFooter>
End Sub
...
Write_BlockedWithShieldUser_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.Write_BlockedWithShieldUser", Erl)
        '</EhFooter>
End Sub
...
Write_BlockedWithShieldOther_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.Write_BlockedWithShieldOther", Erl)
        '</EhFooter>
End Sub
...
WriteCharSwing_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCharSwing", Erl)
        '</EhFooter>
End Sub
...
WriteSafeModeOn_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSafeModeOn", Erl)
        '</EhFooter>
End Sub
...
WriteSafeModeOff_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSafeModeOff", Erl)
        '</EhFooter>
End Sub
...
WritePartySafeOn_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePartySafeOn", Erl)
        '</EhFooter>
End Sub
...
WritePartySafeOff_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePartySafeOff", Erl)
        '</EhFooter>
End Sub
...
WriteClanSeguro_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteClanSeguro", Erl)
        '</EhFooter>
End Sub
...
WriteSeguroResu_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSeguroResu", Erl)
        '</EhFooter>
End Sub
...
WriteCantUseWhileMeditating_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCantUseWhileMeditating", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateSta_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateSta", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateMana_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateMana", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateHP_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateHP", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateGold_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateGold", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateExp_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateExp", Erl)
        '</EhFooter>
End Sub
...
WriteChangeMap_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChangeMap", Erl)
        '</EhFooter>
End Sub
...
102     Call Writer.WriteInt16(UserList(UserIndex).Pos.X)
104     Call Writer.WriteInt16(UserList(UserIndex).Pos.Y)
106     Call modSendData.SendData(ToIndex, UserIndex)
...
WritePosUpdate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePosUpdate", Erl)
        '</EhFooter>
End Sub
...
' @param    UserIndex User to which the message is intended.
' @remarks  The data is not actually sent until the buffer is properly flushed.
Public Sub WritePosUpdateCharIndex(ByVal UserIndex As Integer, ByVal X As Integer, ByVal Y As Integer, ByVal charindex As Integer)
        '<EhHeader>
...
WritePosUpdateCharIndex_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePosUpdateCharIndex", Erl)
        '</EhFooter>
End Sub
...
' @param    UserIndex User to which the message is intended.
' @remarks  The data is not actually sent until the buffer is properly flushed.
Public Sub WritePosUpdateChar(ByVal UserIndex As Integer, ByVal X As Integer, ByVal Y As Integer, ByVal charindex As Integer)
        '<EhHeader>
...
WritePosUpdateChar_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePosUpdateChar", Erl)
        '</EhFooter>
End Sub
...
WriteNPCHitUser_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNPCHitUser", Erl)
        '</EhFooter>
End Sub
...
WriteUserHitNPC_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserHitNPC", Erl)
        '</EhFooter>
End Sub
...
WriteUserAttackedSwing_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserAttackedSwing", Erl)
        '</EhFooter>
End Sub
...
WriteUserHittedByUser_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserHittedByUser", Erl)
        '</EhFooter>
End Sub
...
WriteUserHittedUser_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserHittedUser", Erl)
        '</EhFooter>
End Sub
...
WriteChatOverHead_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChatOverHead", Erl)
        '</EhFooter>
End Sub
...
WriteTextOverChar_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteTextOverChar", Erl)
        '</EhFooter>
End Sub
...
WriteTextOverTile_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteTextOverTile", Erl)
        '</EhFooter>
End Sub
...
WriteTextCharDrop_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteTextCharDrop", Erl)
        '</EhFooter>
End Sub
...
Public Sub WriteConsoleMsg(ByVal UserIndex As Integer, _
                           ByVal chat As String, _
                           Optional ByVal FontIndex As e_FontTypeNames = e_FontTypeNames.FONTTYPE_INFO)
        '<EhHeader>
...
WriteConsoleMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteConsoleMsg", Erl)
        '</EhFooter>
End Sub
...
WriteLocaleMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteLocaleMsg", Erl)
        '</EhFooter>
End Sub
...
WriteGuildChat_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGuildChat", Erl)
        '</EhFooter>
End Sub
...
WriteShowMessageBox_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowMessageBox", Erl)
        '</EhFooter>
End Sub
...
WriteUserIndexInServer_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserIndexInServer", Erl)
        '</EhFooter>
End Sub
...
WriteUserCharIndexInServer_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserCharIndexInServer", Erl)
        '</EhFooter>
End Sub
...
WriteCharacterCreate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCharacterCreate", Erl)
        '</EhFooter>
End Sub
...
WriteCharacterUpdateFlag_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCharacterUpdateFlag", Erl)
        '</EhFooter>
End Sub
...
WriteForceCharMove_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteForceCharMove", Erl)
        '</EhFooter>
End Sub
...
WriteForceCharMoveSiguiendo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteForceCharMoveSiguiendo", Erl)
        '</EhFooter>
End Sub
...
WriteCharacterChange_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCharacterChange", Erl)
        '</EhFooter>
End Sub
...
WriteObjectCreate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteObjectCreate", Erl)
        '</EhFooter>
End Sub
...
WriteParticleFloorCreate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteParticleFloorCreate", Erl)
        '</EhFooter>
End Sub
...
Public Sub WriteLightFloorCreate(ByVal UserIndex As Integer, _
        ...
        '</EhHeader>
100     MapData(Map).Tile(X, Y).Luz.Color = LuzColor
102     MapData(Map).Tile(X, Y).Luz.Rango = Rango
...
WriteLightFloorCreate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteLightFloorCreate", Erl)
        '</EhFooter>
End Sub
...
WriteFxPiso_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteFxPiso", Erl)
        '</EhFooter>
End Sub
...
WriteObjectDelete_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteObjectDelete", Erl)
        '</EhFooter>
End Sub
...
Write_BlockPosition_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.Write_BlockPosition", Erl)
        '</EhFooter>
End Sub
...
WritePlayMidi_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePlayMidi", Erl)
        '</EhFooter>
End Sub
...
WritePlayWave_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePlayWave", Erl)
        '</EhFooter>
End Sub
...
WritePlayWaveStep_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePlayWaveStep", Erl)
        '</EhFooter>
End Sub
...
WriteGuildList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGuildList", Erl)
        '</EhFooter>
End Sub
...
' @param    UserIndex User to which the message is intended.
' @remarks  The data is not actually sent until the buffer is properly flushed.
Public Sub WriteAreaChanged(ByVal UserIndex As Integer, ByVal X As Integer, ByVal Y As Integer, ByVal Heading As Byte)
        '<EhHeader>
...
WriteAreaChanged_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteAreaChanged", Erl)
        '</EhFooter>
End Sub
...
WritePauseToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePauseToggle", Erl)
        '</EhFooter>
End Sub
...
WriteRainToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteRainToggle", Erl)
        '</EhFooter>
End Sub
...
WriteNubesToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNubesToggle", Erl)
        '</EhFooter>
End Sub
...
Public Sub WriteCreateFX(ByVal UserIndex As Integer, _
        ...
        '***************************************************
        'Author: Juan MartÃ¯¿Â½n Sotuyo Dodero (Maraxus)
...
WriteCreateFX_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCreateFX", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateUserStats_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateUserStats", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateUserKey_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateUserKey", Erl)
        '</EhFooter>
End Sub

' Actualiza el indicador de daÃ¯¿Â½o mÃ¯¿Â½gico
...
WriteUpdateDM_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateDM", Erl)
        '</EhFooter>
End Sub

' Actualiza el indicador de resistencia mÃ¯¿Â½gica
...
WriteUpdateRM_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateRM", Erl)
        '</EhFooter>
End Sub
...
WriteWorkRequestTarget_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteWorkRequestTarget", Erl)
        '</EhFooter>
End Sub
...
WriteInventoryUnlockSlots_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteInventoryUnlockSlots", Erl)
        '</EhFooter>
End Sub
...
WriteIntervals_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteIntervals", Erl)
        '</EhFooter>
End Sub
...
WriteChangeInventorySlot_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChangeInventorySlot", Erl)
        '</EhFooter>
End Sub
...
WriteChangeBankSlot_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChangeBankSlot", Erl)
        '</EhFooter>
End Sub
...
WriteChangeSpellSlot_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChangeSpellSlot", Erl)
        '</EhFooter>
End Sub
...
WriteAttributes_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteAttributes", Erl)
        '</EhFooter>
End Sub
...
WriteBlacksmithWeapons_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBlacksmithWeapons", Erl)
        '</EhFooter>
End Sub
...
WriteBlacksmithArmors_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBlacksmithArmors", Erl)
        '</EhFooter>
End Sub
...
WriteCarpenterObjects_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCarpenterObjects", Erl)
        '</EhFooter>
End Sub
...
WriteAlquimistaObjects_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteAlquimistaObjects", Erl)
        '</EhFooter>
End Sub
...
WriteSastreObjects_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSastreObjects", Erl)
        '</EhFooter>
End Sub
...
WriteRestOK_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteRestOK", Erl)
        '</EhFooter>
End Sub
...
WriteErrorMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteErrorMsg", Erl)
        '</EhFooter>
End Sub
...
WriteBlind_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBlind", Erl)
        '</EhFooter>
End Sub
...
WriteDumb_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteDumb", Erl)
        '</EhFooter>
End Sub
...
WriteShowSignal_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowSignal", Erl)
        '</EhFooter>
End Sub
...
WriteChangeNPCInventorySlot_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChangeNPCInventorySlot", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateHungerAndThirst_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateHungerAndThirst", Erl)
        '</EhFooter>
End Sub
...
WriteFlashScreen_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteFlashScreen", Erl)
        '</EhFooter>
End Sub
...
WriteFYA_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteFYA", Erl)
        '</EhFooter>
End Sub
...
WriteCerrarleCliente_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCerrarleCliente", Erl)
        '</EhFooter>
End Sub
...
WriteContadores_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteContadores", Erl)
        '</EhFooter>
...
WriteShowPapiro_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowPapiro", Erl)
End Sub
...
WritePrivilegios_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePrivilegios", Erl)
        '</EhFooter>
End Sub
...
WriteBindKeys_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBindKeys", Erl)
        '</EhFooter>
End Sub
...
WriteNotificarClienteSeguido_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNotificarClienteSeguido", Erl)
        '</EhFooter>
End Sub
...
GetInventarioHechizos_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.GetInventarioHechizos", Erl)
        '</EhFooter>
End Sub
...
NofiticarClienteCasteo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.NofiticarClienteCasteo", Erl)
        '</EhFooter>
End Sub
...
WriteCancelarSeguimiento_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCancelarSeguimiento", Erl)
End Sub
...
WriteSendFollowingCharindex_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSendFollowingCharindex", Erl)
End Sub
''
...
102     Call Writer.WriteInt32(UserList(UserIndex).Stats.ciudadanosMatados)
104     Call Writer.WriteInt32(UserList(UserIndex).Stats.CriminalesMatados)
106     Call Writer.WriteInt8(UserList(UserIndex).Faccion.Status)
108     Call Writer.WriteInt32(UserList(UserIndex).Stats.NPCsMatados)
110     Call Writer.WriteInt8(UserList(UserIndex).clase)
112     Call Writer.WriteInt32(UserList(UserIndex).Counters.Pena)
114     Call Writer.WriteInt32(UserList(UserIndex).Stats.MuertesTotales)
...
WriteMiniStats_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteMiniStats", Erl)
        '</EhFooter>
End Sub
...
WriteLevelUp_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteLevelUp", Erl)
        '</EhFooter>
End Sub
...
WriteAddForumMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteAddForumMsg", Erl)
        '</EhFooter>
End Sub
...
WriteShowForumForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowForumForm", Erl)
        '</EhFooter>
End Sub
...
WriteSetInvisible_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSetInvisible", Erl)
        '</EhFooter>
End Sub
...
WriteMeditateToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteMeditateToggle", Erl)
        '</EhFooter>
End Sub
...
WriteBlindNoMore_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteBlindNoMore", Erl)
        '</EhFooter>
End Sub
...
WriteDumbNoMore_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteDumbNoMore", Erl)
        '</EhFooter>
End Sub
...
104         Call Writer.WriteInt8(UserList(UserIndex).Stats.UserSkills(i))
            Call Writer.WriteInt8(UserList(UserIndex).Stats.UserSkillsAssigned(i))
106     Next i
...
WriteSendSkills_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSendSkills", Erl)
        '</EhFooter>
End Sub
...
WriteTrainerCreatureList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteTrainerCreatureList", Erl)
        '</EhFooter>
End Sub
...
WriteGuildNews_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGuildNews", Erl)
        '</EhFooter>
End Sub
...
WriteOfferDetails_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteOfferDetails", Erl)
        '</EhFooter>
End Sub
...
WriteAlianceProposalsList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteAlianceProposalsList", Erl)
        '</EhFooter>
End Sub
...
WritePeaceProposalsList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePeaceProposalsList", Erl)
        '</EhFooter>
End Sub
...
WriteCharacterInfo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCharacterInfo", Erl)
        '</EhFooter>
End Sub
...
WriteGuildLeaderInfo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGuildLeaderInfo", Erl)
        '</EhFooter>
End Sub
...
WriteGuildDetails_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGuildDetails", Erl)
        '</EhFooter>
End Sub
...
WriteShowGuildFundationForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowGuildFundationForm", Erl)
        '</EhFooter>
End Sub
...
WriteParalizeOK_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteParalizeOK", Erl)
        '</EhFooter>
End Sub
...
WriteInmovilizaOK_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteInmovilizaOK", Erl)
        '</EhFooter>
End Sub
...
WriteStopped_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteStopped", Erl)
        '</EhFooter>
End Sub
...
WriteShowUserRequest_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowUserRequest", Erl)
        '</EhFooter>
End Sub
...
WriteChangeUserTradeSlot_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteChangeUserTradeSlot", Erl)
        '</EhFooter>
End Sub
...
WriteSpawnList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSpawnList", Erl)
        '</EhFooter>
End Sub
...
WriteShowSOSForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowSOSForm", Erl)
        '</EhFooter>
End Sub
...
WriteShowMOTDEditionForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowMOTDEditionForm", Erl)
        '</EhFooter>
End Sub
...
WriteShowGMPanelForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowGMPanelForm", Erl)
        '</EhFooter>
End Sub
...
WriteShowFundarClanForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowFundarClanForm", Erl)
        '</EhFooter>
End Sub
...
WriteUserNameList_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUserNameList", Erl)
        '</EhFooter>
End Sub


Public Sub WriteGoliathInit(ByVal UserIndex As Integer, ByVal Gold As Long)
        '<EhHeader>
        On Error GoTo WriteGoliathInit_Err
        '</EhHeader>
100     Call Writer.WriteInt16(ServerPacketID.Goliath)
102     Call Writer.WriteInt32(Gold)
...
WriteGoliathInit_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGoliathInit", Erl)
        '</EhFooter>
End Sub
...
WritePelearConPezEspecial_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePelearConPezEspecial", Erl)
        '</EhFooter>
End Sub

Public Sub WriteUpdateBankGld(ByVal UserIndex As Integer, ByVal Gold As Long)
        '<EhHeader>
...
WriteUpdateBankGld_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateBankGld", Erl)
        '</EhFooter>
End Sub
...
WriteShowFrmLogear_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowFrmLogear", Erl)
        '</EhFooter>
End Sub
...
WriteShowFrmMapa_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShowFrmMapa", Erl)
        '</EhFooter>
End Sub
...
WritePreguntaBox_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WritePreguntaBox", Erl)
        '</EhFooter>
End Sub
...
126                         Call Writer.WriteString8(UserList(UserList( _
                                    .Grupo.Lider).Grupo.Miembros(i)).Name & "(LÃ¯¿Â½der)")
                        Else
...
WriteDatosGrupo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteDatosGrupo", Erl)
        '</EhFooter>
End Sub
...
104     If GPS > 0 Then
106         Call Writer.WriteInt16(UserList(GPS).Pos.X)
108         Call Writer.WriteInt16(UserList(GPS).Pos.Y)
...
WriteUbicacion_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUbicacion", Erl)
        '</EhFooter>
End Sub
...
WriteViajarForm_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteViajarForm", Erl)
        '</EhFooter>
End Sub
...
100     Call Writer.WriteInt16(ServerPacketID.QuestDetails)
        'Se usa la variable QuestSlot para saber si enviamos la info de una quest ya empezada o la info de una quest que no se aceptÃ¯¿Â½ todavÃ¯¿Â½a (1 para el primer caso y 0 para el segundo)
102     Call Writer.WriteInt8(IIf(QuestSlot, 1, 0))
        'Enviamos nombre, descripciÃ¯¿Â½n y nivel requerido de la quest
...
118             Call Writer.WriteInt16(QuestList(QuestIndex).RequiredNPC(i).NpcIndex)
                ...
                'Si es una quest ya empezada, entonces mandamos los NPCs que matÃ¯¿Â½.
...
WriteQuestDetails_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteQuestDetails", Erl)
        '</EhFooter>
End Sub
...
114         Call Writer.WriteInt8(tmpByte)
            ...
            'Escribimos la lista de quests (sacamos el Ã¯¿Â½ltimo caracter)
116         If tmpByte Then
...
WriteQuestListSend_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteQuestListSend", Erl)
        '</EhFooter>
End Sub
...
WriteNpcQuestListSend_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteNpcQuestListSend", Erl)
        '</EhFooter>
End Sub
...
WriteCommerceRecieveChatMessage_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCommerceRecieveChatMessage", Erl)
        '</EhFooter>
End Sub
...
WriteInvasionInfo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteInvasionInfo", Erl)
        '</EhFooter>
End Sub
...
WriteOpenCrafting_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteOpenCrafting", Erl)
        '</EhFooter>
End Sub
...
WriteCraftingItem_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCraftingItem", Erl)
        '</EhFooter>
End Sub
...
WriteCraftingCatalyst_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCraftingCatalyst", Erl)
        '</EhFooter>
End Sub
...
WriteCraftingResult_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteCraftingResult", Erl)
        '</EhFooter>
End Sub
...
WriteForceUpdate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteForceUpdate", Erl)
        '</EhFooter>
End Sub
...
WriteUpdateNPCSimbolo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteUpdateNPCSimbolo", Erl)
        '</EhFooter>
End Sub
...
WriteGuardNotice_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteGuardNotice", Erl)
        '</EhFooter>
End Sub
...
PrepareMessageCharSwing_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharSwing", Erl)
        '</EhFooter>
End Function
...
PrepareMessageSetInvisible_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageSetInvisible", Erl)
        '</EhFooter>
End Function
...
PrepareMessageChatOverHead_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageChatOverHead", Erl)
        '</EhFooter>
End Function
...
PrepareMessageTextOverChar_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageTextOverChar", Erl)
        '</EhFooter>
End Function
...
PrepareMessageTextCharDrop_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageTextCharDrop", Erl)
        '</EhFooter>
End Function
...
PrepareMessageTextOverTile_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageTextOverTile", Erl)
        '</EhFooter>
End Function
...
PrepareMessageConsoleMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageConsoleMsg", Erl)
        '</EhFooter>
End Function
...
PrepareMessageLocaleMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageLocaleMsg", Erl)
        '</EhFooter>
End Function
...
PrepareMessageCharAtaca_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharAtaca", Erl)
        '</EhFooter>
End Function
...
PrepareMessageCreateFX_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCreateFX", Erl)
        '</EhFooter>
End Function
...
PrepareMessageMeditateToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageMeditateToggle", Erl)
        '</EhFooter>
End Function
...
PrepareMessageParticleFX_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageParticleFX", Erl)
        '</EhFooter>
End Function
...
115     Call Writer.WriteInt16(X)
116     Call Writer.WriteInt16(Y)
...
PrepareMessageParticleFXWithDestino_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageParticleFXWithDestino", Erl)
        '</EhFooter>
End Function
...
PrepareMessageParticleFXWithDestinoXY_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageParticleFXWithDestinoXY", Erl)
        '</EhFooter>
End Function
...
PrepareMessageAuraToChar_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageAuraToChar", Erl)
        '</EhFooter>
End Function
...
PrepareMessageSpeedingACT_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageSpeedingACT", Erl)
        '</EhFooter>
End Function

Public Function PrepareMessageParticleFXToFloor(ByVal X As Integer, _
                                                ByVal Y As Integer, _
                                                ByVal Particula As Integer, _
                                                ByVal Time As Long)
        '<EhHeader>
...
PrepareMessageParticleFXToFloor_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageParticleFXToFloor", Erl)
        '</EhFooter>
End Function

Public Function PrepareMessageLightFXToFloor(ByVal X As Integer, _
                                             ByVal Y As Integer, _
                                             ByVal LuzColor As Long, _
                                             ByVal Rango As Byte)
        '<EhHeader>
...
PrepareMessageLightFXToFloor_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageLightFXToFloor", Erl)
        '</EhFooter>
End Function
...
PrepareMessagePlayWave_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessagePlayWave", Erl)
        '</EhFooter>
End Function
...
PrepareMessageUbicacionLlamada_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageUbicacionLlamada", Erl)
        '</EhFooter>
End Function
...
PrepareMessageCharUpdateHP_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharUpdateHP", Erl)
        '</EhFooter>
End Function
...
PrepareMessageCharUpdateMAN_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharUpdateMAN", Erl)
        '</EhFooter>
End Function
...
PrepareMessageNpcUpdateHP_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageNpcUpdateHP", Erl)
        '</EhFooter>
End Function
...
PrepareMessageArmaMov_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageArmaMov", Erl)
        '</EhFooter>
End Function
...
PrepareMessageEscudoMov_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageEscudoMov", Erl)
        '</EhFooter>
End Function
...
PrepareMessageFlashScreen_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageFlashScreen", Erl)
        '</EhFooter>
End Function
...
PrepareMessageGuildChat_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageGuildChat", Erl)
        '</EhFooter>
End Function
...
PrepareMessageShowMessageBox_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageShowMessageBox", Erl)
        '</EhFooter>
End Function
...
PrepareMessagePlayMidi_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessagePlayMidi", Erl)
        '</EhFooter>
End Function
...
PrepareMessageOnlineUser_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageOnlineUser", Erl)
        '</EhFooter>
End Function
...
PrepareMessagePauseToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessagePauseToggle", Erl)
        '</EhFooter>
End Function
...
PrepareMessageRainToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageRainToggle", Erl)
        '</EhFooter>
End Function
...
PrepareMessageHora_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageHora", Erl)
        '</EhFooter>
End Function
...
' @return   The formated message ready to be writen as is on outgoing buffers.
' @remarks  The data is not actually sent until the buffer is properly flushed.
Public Function PrepareMessageObjectDelete(ByVal X As Integer, ByVal Y As Integer)
        '<EhHeader>
...
PrepareMessageObjectDelete_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageObjectDelete", Erl)
        '</EhFooter>
End Function
...
' @return   The formated message ready to be writen as is on outgoing buffers.
' @remarks  The data is not actually sent until the buffer is properly flushed.
Public Function PrepareMessage_BlockPosition(ByVal X As Integer, _
                                            ByVal Y As Integer, _
                                            ByVal Blocked As Byte)
        '<EhHeader>
...
PrepareMessage_BlockPosition_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessage_BlockPosition", Erl)
        '</EhFooter>
End Function
...
PrepareMessageObjectCreate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageObjectCreate", Erl)
        '</EhFooter>
End Function
...
PrepareMessageFxPiso_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageFxPiso", Erl)
        '</EhFooter>
End Function
...
PrepareMessageCharacterRemove_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharacterRemove", Erl)
        '</EhFooter>
End Function
...
PrepareMessageRemoveCharDialog_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageRemoveCharDialog", Erl)
        '</EhFooter>
End Function
...
110     Call Writer.WriteInt16(X)
112     Call Writer.WriteInt16(Y)
...
PrepareMessageCharacterCreate_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharacterCreate", Erl)
        '</EhFooter>
End Function
...
PrepareMessageCharacterChange_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharacterChange", Erl)
        '</EhFooter>
End Function
...
PrepareMessageUpdateFlag_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageUpdateFlag", Erl)
        '</EhFooter>
End Function
''
...
PrepareMessageCharacterMove_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageCharacterMove", Erl)
        '</EhFooter>
End Function
...
PrepareMessageForceCharMove_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageForceCharMove", Erl)
        '</EhFooter>
End Function
...
PrepareMessageForceCharMoveSiguiendo_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageForceCharMoveSiguiendo", Erl)
        '</EhFooter>
End Function
''
...
PrepareMessageUpdateTagAndStatus_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageUpdateTagAndStatus", Erl)
        '</EhFooter>
End Function
...
PrepareMessageErrorMsg_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageErrorMsg", Erl)
        '</EhFooter>
End Function
...
PrepareMessageBarFx_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageBarFx", Erl)
        '</EhFooter>
End Function
...
PrepareMessageNieblandoToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageNieblandoToggle", Erl)
        '</EhFooter>
End Function
...
PrepareMessageNevarToggle_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageNevarToggle", Erl)
        '</EhFooter>
End Function
...
PrepareMessageDoAnimation_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PrepareMessageDoAnimation", Erl)
End Function
...
'PescarEspecial_Err:
'        Call Writer.Clear
'        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.PescarEspecial", Erl)
'End Function
...
writeAnswerReset_Err:
        Call Writer.Clear
        Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.writeAnswerReset", Erl)
        '</EhFooter>
End Sub
...
WriteShopInit_Err:
     Call Writer.Clear
    Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShopInit", Erl)
End Sub
...
WriteShopPjsInit_Err:
     Call Writer.Clear
    Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteShopPjsInit", Erl)
End Sub
...
writeUpdateShopClienteCredits_Err:
     Call Writer.Clear
    Call TraceError(Err.Number, Err.Description + " UI: " + UserIndex, "ArgentumServer.Protocol_Writes.writeUpdateShopClienteCredits", Erl)
    
End Sub

Public Sub WriteSendComboCooldown(ByVal UserIndex As Integer, ByVal Time As Integer)
    On Error GoTo WriteSendComboCooldown_Err
    
    Call Writer.WriteInt16(ServerPacketID.ComboCooldown)
    Call Writer.WriteInt16(Time)
    
182 Call modSendData.SendData(ToIndex, UserIndex)
    
WriteSendComboCooldown_Err:
     Call Writer.Clear
    Call TraceError(Err.Number, Err.Description, "ArgentumServer.Protocol_Writes.WriteSendComboCooldown", Erl)
End Sub
