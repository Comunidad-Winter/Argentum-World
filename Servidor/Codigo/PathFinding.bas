...
100     InsideLimits = X >= 1 And X <= Mapinfo(Map).Width And Y >= 1 And Y <= Mapinfo(Map).Height
...
Private Sub InitializeTable(ByRef Table() As t_IntermidiateWork, ByVal Map As Integer, ByRef PosNPC As t_Position, ByVal RangoVision As Single)
