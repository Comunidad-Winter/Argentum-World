...
124             If .Stats.ciudadanosMatados > 0 Then
...
138             If .Stats.CriminalesMatados < primerRango.AsesinatosRequeridos Then
140                 Call WriteChatOverHead(UserIndex, "Para unirte a nuestras fuerzas debes matar al menos " & primerRango.AsesinatosRequeridos & " criminales, solo has matado " & .Stats.CriminalesMatados, charIndexStr, vbWhite)
                    Exit Sub
...
164                 Call WriteChatOverHead(UserIndex, "¡Bienvenido al Ejercito Imperial!, aquí tienes tus vestimentas. Cumple bien tu labor exterminando Criminales y me encargaré de recompensarte.", charIndexStr, vbWhite)

166                 .Faccion.NivelIngreso = .Stats.ELV
168                 .Faccion.MatadosIngreso = .Stats.ciudadanosMatados
...
100         With UserList(UserIndex)
102             Crimis = .Stats.CriminalesMatados
...
134             If .Stats.ciudadanosMatados < primerRango.AsesinatosRequeridos Then
136                 Call WriteChatOverHead(UserIndex, "Para unirte a nuestras fuerzas debes matar al menos " & primerRango.AsesinatosRequeridos & " ciudadanos, solo has matado " & .Stats.ciudadanosMatados, charIndexStr, vbWhite)
                    Exit Sub
...
100         With UserList(UserIndex)
102             ciudadanosMatados = .Stats.ciudadanosMatados
104             npcCharIndex = str(NpcList(.flags.TargetNPC).Char.charindex)
