...
346                             Call WriteWorkRequestTarget(UserIndex, 0)
                ...
                Case e_Skill.Carpinteria
                    ...
                    If UserList(UserIndex).Stats.UserSkills(e_Skill.Carpinteria) < 5 Then
                        Call WriteConsoleMsg(UserIndex, "Para poder empezar a realizar carpintería debes asignar 5 skills en carpintería.", e_FontTypeNames.FONTTYPE_INFO)
                        Call WriteWorkRequestTarget(UserIndex, 0)
                        Exit Sub
                    End If
                ...
                Case e_Skill.Mineria
                    If UserList(UserIndex).Stats.UserSkills(e_Skill.Mineria) < 5 Then
                        Call WriteConsoleMsg(UserIndex, "Para poder empezar a minar debes asignar 5 skills en minería.", e_FontTypeNames.FONTTYPE_INFO)
                        Call WriteWorkRequestTarget(UserIndex, 0)
                        Exit Sub
                    End If
...
498                             Call WriteWorkRequestTarget(UserIndex, 0)
                ...
                Case e_Skill.Talar
                    If UserList(UserIndex).Stats.UserSkills(e_Skill.Talar) < 5 Then
                        Call WriteConsoleMsg(UserIndex, "Para poder empezar a talar debes asignar 5 skills en talar árboles.", e_FontTypeNames.FONTTYPE_INFO)
                        Call WriteWorkRequestTarget(UserIndex, 0)
                        Exit Sub
                    End If
...
574             Case e_Skill.Herreria
                    If UserList(UserIndex).Stats.UserSkills(e_Skill.Herreria) < 5 Then
                        Call WriteConsoleMsg(UserIndex, "Para poder empezar a realizar herrería debes asignar 5 skills en herrería.", e_FontTypeNames.FONTTYPE_INFO)
                        Call WriteWorkRequestTarget(UserIndex, 0)
                        Exit Sub
                    End If
...
116             Call WriteConsoleMsg(UserIndex, "Los mortales no pueden fundir este mineral.", e_FontTypeNames.FONTTYPE_INFO)
            ...
            Else
118             Call WriteConsoleMsg(UserIndex, "No tenés conocimientos de minería suficientes para trabajar este mineral. Necesitas " & SkillRequerido & " puntos en herrería.", e_FontTypeNames.FONTTYPE_INFO)
