...
Public Const MAXSPAWNATTEMPS = 25
...
Public Type t_UserStats
    ...
    UserSkillsAssigned(1 To NUMSKILLS) As Byte
    ...
    MuertesTotales As Long
    MuertesPorNpcs  As Long
    MuertesPorUsers  As Long
    pasos As Long
    TiempoJugado As Long
End Type
...
Public Type t_UserFlags
    ...
    'Buff de clases
    attacker_index_combo As Integer
    victim_index_combo As Integer
...
Public Type t_UserCounters
    ...
    'Buff de clases
    buff_start_time As Long
    buff_combo_count As Byte
...
Public Type t_UserTrabajo
    ...
    Target_X As Integer
    Target_Y As Integer
    'Para macro de Carpinteria, Herreria y Sastreria
    Item As Integer
    Cantidad As Long
End Type
...
Public Const HALF_X As Byte = 12
Public Const HALF_Y As Byte = 12
...
Public LastNumUsers                          As Integer
