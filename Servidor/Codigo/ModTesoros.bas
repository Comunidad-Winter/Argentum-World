...
112         If (MapData(TesoroNumMapa).Tile(TesoroX, TesoroY).Blocked And e_Block.ALL_SIDES) <> e_Block.ALL_SIDES Then
114             If (MapData(TesoroNumMapa).Tile(TesoroX, TesoroY).Blocked And FLAG_AGUA) = 0 Then
...
108     Do While Not EncontreLugar
110     Iterations = Iterations + 1
112         If (MapData(RegaloNumMapa).Tile(RegaloX, RegaloY).Blocked And e_Block.ALL_SIDES) <> e_Block.ALL_SIDES Then
114             If (MapData(RegaloNumMapa).Tile(RegaloX, RegaloY).Blocked And FLAG_AGUA) = 0 Then
116                 EncontreLugar = True
                Else
118                 EncontreLugar = False
