...
Public Const MIN_SALA_ESPERA_x As Integer = 45
Public Const MIN_SALA_ESPERA_y As Integer = 68
Public Const MAX_SALA_ESPERA_x As Integer = 56
Public Const MAX_SALA_ESPERA_y As Integer = 73
