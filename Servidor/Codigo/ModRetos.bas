...
100     With UserList(Oferente).flags.SolicitudReto
            ...
            ' Ãšltima comprobación de si todos pueden entrar/pagar
...
122                 Call WriteConsoleMsg(tIndex, "Comienza la ronda NÂº" & .Ronda, e_FontTypeNames.FONTTYPE_GUILD)
...
162                             Equipo1 = UserList(tIndex).Name
                ...
                ' Anuncio global
164             Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Retos Â» " & Equipo1 & " vs " & Equipo2 & ". Ninguno pudo vencer a su rival.", e_FontTypeNames.FONTTYPE_INFO))
...
248                 Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Retos Â» El equipo " & equipoGanador & " venció al equipo " & equipoPerdedor & " y se quedo con el botín de: " & PonerPuntos(.Apuesta) & " monedas de oro. ", e_FontTypeNames.FONTTYPE_INFO))
        
                Else ' 1 vs 1
250                 Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Retos Â» " & equipoGanador & " venció a " & equipoPerdedor & " y se quedo con el botín de: " & PonerPuntos(.Apuesta) & " monedas de oro. ", e_FontTypeNames.FONTTYPE_INFO))
