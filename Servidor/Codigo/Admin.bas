...
100     Call SendData(SendTarget.ToGM, 0, PrepareMessageConsoleMsg("Servidor Â» Iniciando WorldSave", e_FontTypeNames.FONTTYPE_SERVER))
...
126     Call SendData(SendTarget.ToGM, 0, PrepareMessageConsoleMsg("Servidor Â» WorldSave ha concluído", e_FontTypeNames.FONTTYPE_SERVER))
