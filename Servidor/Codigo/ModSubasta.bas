...
108     If Not MapData(UserList(UserIndex).Pos.Map).Tile(UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y).ObjInfo.ObjIndex > 0 Then
...
112     If Not ObjData(MapData(UserList(UserIndex).Pos.Map).Tile(UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y).ObjInfo.ObjIndex).Subastable = 1 Then
...
124     If MapData(UserList(UserIndex).Pos.Map).Tile(UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y).ObjInfo.ObjIndex > 0 Then
126         Subasta.ObjSubastado = MapData(UserList(UserIndex).Pos.Map).Tile(UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y).ObjInfo.ObjIndex
128         Subasta.ObjSubastadoCantidad = MapData(UserList(UserIndex).Pos.Map).Tile(UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y).ObjInfo.Amount
...
140             If MapData(PosMap).Tile(PosX, PosY).ObjInfo.ObjIndex > 0 Then Exit Sub

142             If MapData(PosMap).Tile(PosX, PosY).TileExit.Map <> 0 Then Exit Sub
...
138             If MapData(PosMap).Tile(PosX, PosY).ObjInfo.ObjIndex > 0 Then Exit Sub

140             If MapData(PosMap).Tile(PosX, PosY).TileExit.Map <> 0 Then Exit Sub
