...
100     If MsgBox("¡Atención! Si reinicia el servidor puede provocar la perdida de datos de los usarios. ¿Desea reiniciar el servidor de todas maneras?", vbYesNo) = vbYes Then
...
126     Call FreeCharIndexes
        ...
        FrmStat.uAOProgress1.value = 20

128     Call LoadSini

        FrmStat.uAOProgress1.value = 30
130     Call LoadIntervalos

        FrmStat.uAOProgress1.value = 40
134     Call LoadOBJData

        FrmStat.uAOProgress1.value = 70
136     Call LoadPesca

        FrmStat.uAOProgress1.value = 80
138     Call LoadRecursosEspeciales

        FrmStat.uAOProgress1.value = 90
...
142     If frmMain.Visible Then frmMain.txStatus.Caption = "Escuchando conexiones entrantes ..."
        ...
        FrmStat.uAOProgress1.value = 100
